...
/* 🚩 Dimension Switch Auto Manuel voir Informations */
.toggle{position:relative; width:56px; height:30px; flex-shrink:0; et translateX(26px)}
...
.toggle .track::before{content:""; position:absolute; height:17px; width:17px; left:4px; top:4px; background:#fff; border-radius:50%; transition:transform .2s; box-shadow:0 1px 3px rgba(0,0,0,.4);}
